...
const getBookingById = async (bookingId) => {
  try {
    ...
    // Some SPs return a single JSON column (FOR JSON PATH)
    ...
    // Deep parse nested JSON fields (selections, passengers, SSR)
...
const createBooking = async (bookingData) => {
  ...
  try {
    ...
    if (!fetchResult.success) throw new Error(fetchResult.error || "Failed to fetch booking");
